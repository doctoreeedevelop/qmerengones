                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="form-group">
                                        <div
                                            ...
                                            <input type="checkbox" class="custom-control-input" id="masvendidos"
                                                name="masvendidos">
                                    ...
                                    <div class="form-group">
                                        <div
                                            class="custom-control custom-switch custom-switch-off-danger custom-switch-on-success">
                                            <input type="checkbox" class="custom-control-input" id="promociones"
                                                name="promociones">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input :disabled="deshabilitar_boton==1" type="submit" value="Guardar"
                                                class="btn btn-primary" @click = "mensajcreat">
