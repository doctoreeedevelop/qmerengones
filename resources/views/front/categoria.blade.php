...
@else
{{ $productos[1]->images->count() }} 
@endif --}}



{{-- {{ $productos->images[0]->url }} --}}
...
<section class="extcat p-t-23 p-b-130 mt-56">
   


	<section class="bg0 m-t-130 p-b-50">
		<div class="container">
			<div class="p-b-10">
				...
				<section class="tarjeta2 carddos">
					...
					<div class="carduno block2-pic hov-img0">
                        @if ($product->images->count()<=0)
							<img class="imgcat" src="{{ asset ('asset/plantillappal/imagenes/sinimagen.jpg')}}" alt="IMG-PRODUCT">
                        @else
                           <img class="imgcat" src="{{ $product->images[0]->url}}" alt="">   
                      	@endif
					...
					<a href="{{route('cartadd', $product->id)}}" class="botoncar2">
						Lo Quiero
					</a> 
