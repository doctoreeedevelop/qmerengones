...
<section class="cataextuno p-t-23 p-b-130">
    
        <section class="cataextdos bg0 p-b-50">
		...
		<section class="maindos">
			...
			<section class="carddos">
				...
				<div class="carduno block2-pic hov-img0">
								...
								@else
									<img class="imgmasv" src="{{ $producto->images[0]->url}}" alt="">   
								@endif
						

								<a href="{{ route('detalle', $producto->id) }}" class="block2-btn flex-c-m stext-103 cl2 size-102 bg0 bor2 hov-btn1 p-lr-15 trans-04 jjs-show-modal1">
									Detalle...
								</a>
				...
				<div class = extbtnloquiero>
					<a href="{{route('cartadd', $producto->id)}}" 
						class="botondos stext-103 trans-04 "
						v-on:click="agregoalcart({{$producto->id}})"  
						>
						Lo Quiero
					</a> 
				</div>
