...
class Order extends Model
{
    ...
    public static function my_store(){
        ...
        //$tax = Setting::find(1)->pluck('tax'); //original
        //$tax = 0;  //invento
        $order = self::create([
        ...
        //$order->add_order_details($shopping_cart); //original
        //dd($order);
        self::make_order_notification($order); //original
    ...
    public static function make_order_notification($order){
        event(new OrderEvent($order));      //original
