                        ...
                        <div class="wrap-slick3 flex-sb flex-w">
                            ...
                            <div class="slick3 gallery-lb">
                                ...
                                @if ($productos[0]->images->count()<=0) 
                                    <div data-thumb=" {{ asset ('asset/plantillappal/imagenes/avatar.jpg')  }}">
                               
                                @else
                                    <div class="item-slick3" data-thumb="{{ $productos[0]->images[0]->url }}">
                            ...
                            <div class="slick3 gallery-lb">
                                ...
                                @if ($productos[0]->images->count()<=0) 
                                    <div data-thumb=" {{ asset ('asset/plantillappal/imagenes/uñas.jpg')  }}">
                                @else
                                    <div class="item-slick3" data-thumb="{{ $productos[0]->images[0]->url }}">
                                ...
                                @endif
                                    ...
                                    <div class="wrap-pic-w pos-relative">
                                        ...
                                        @else ( $product->images[0]->urlppal )
                                                                
                                            <img src=" {{ $productos[0]->images[0]->urlppal }}" alt="IMG-PRODUCT">   
                                        ...
                                        @if ($productos[0]->images->count()<=0)                            
                                            <img src="/imagenes/avatar.png" alt="">
                                        @else
                                            <img src="{{ $productos[0]->images[0]->urlppal}}" alt="">   
                                        @endif
            
                                        

                                        <a class="flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04" href="{{$productos[0]->imgppal}}">
                                            <i class="fa fa-expand"></i>
                                        </a>
                                    </div>
                                </div>
